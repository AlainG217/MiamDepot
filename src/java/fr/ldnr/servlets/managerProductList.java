 ...
 * @author Monnier.M
 */
@WebServlet(name = "managerProductList", urlPatterns = {"/managerProductList"})
...
*/         
    ...
    throws ServletException, IOException {
            ...
            this.getServletContext().getRequestDispatcher("/WEB-INF/gestionProduit.jsp" ).forward( request, response );
